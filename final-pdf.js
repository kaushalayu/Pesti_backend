...
const generatePdfs = async () => {
  ...
  try {
    if (fs.existsSync(LOGO_PATH)) {
      ...
      logoHtml = `<img src="data:image/jpeg;base64,${imgBuffer.toString('base64')}" style="width:65px;height:65px;border-radius:6px;object-fit:contain;background:white;padding:4px;">`;
    }
  ...
  <div style="max-width:750px;margin:0 auto;">
    <div class="header">
      ...
      <div class="company-info">
        <h1>SAFE HOME PESTOCHEM INDIA PVT. LTD.</h1>
        <p>Professional Pest Control Services | ISO 9001:2015 Certified</p>
        <p style="font-size:9px;margin-top:4px;">Head Office: House No. 780-J, Chaksa Husain, Pachpedwa, Ramjanki Nagar, Basaratpur, Gorakhpur-273004</p>
        <p style="font-size:9px;">Regional Office: H. No-68, Pink City, Sec. 06, Jankipuram Extn., Near Kendria Vihar Colony, Lucknow-226021</p>
        <p style="font-size:9px;">www.safehomepestochem.com | enquiry@safehomepestochem.in | Ph: 25709</p>
        <p style="font-size:8px;">CIN: U52100UP2022PTC164278 | TAN: ALDS10486A | PAN: ABICS5318P</p>
      </div>
    </div>
    <div class="title-bar">
    ...
    <div class="footer">
      <p>Safe Home Pestochem India Pvt. Ltd. | ISO 9001:2015 Certified</p>
    </div>
  </div></body></html>`;
    ...
    await browser.close();
    fs.writeFileSync('receipt_with_logo_terms.pdf', pdf);
    console.log('Receipt PDF: receipt_with_logo_terms.pdf');
  }
  ...
  <div style="max-width:750px;margin:0 auto;">
    <div class="header">
      ${logoHtml ? `<div><img src="data:image/jpeg;base64,${fs.readFileSync(LOGO_PATH).toString('base64')}" style="width:65px;height:65px;border-radius:6px;"></div>` : ''}
      <div class="company-info">
        <h1>SAFE HOME PESTOCHEM INDIA PVT. LTD.</h1>
        <p style="font-size:10px;">Professional Pest Control Services | ISO 9001:2015 Certified</p>
        <p style="font-size:9px;">Head Office: House No. 780-J, Chaksa Husain, Pachpedwa, Gorakhpur-273004</p>
        <p style="font-size:9px;">Regional Office: H. No-68, Pink City, Sec. 06, Lucknow-226021</p>
        <p style="font-size:9px;">www.safehomepestochem.com | enquiry@safehomepestochem.in | Ph: 25709</p>
      </div>
    </div>
    <div class="title-bar">
    ...
    const pdf = await page.pdf({ format: 'A4', printBackground: true, margin: { top: '10mm', bottom: '10mm', left: '10mm', right: '10mm' } });
    await browser.close();
    fs.writeFileSync('jobcard_with_logo_terms.pdf', pdf);
    console.log('Job Card PDF: jobcard_with_logo_terms.pdf');
  }
